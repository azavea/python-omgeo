# -*- coding: utf-8 -*-
#
# python-omgeo documentation build configuration file, created by
...
htmlhelp_basename = 'python-omgeodoc'
...
latex_documents = [
  ('index', 'python-omgeo.tex', u'python-omgeo Documentation',
   u'Andrew Jennings, Joseph Tricarico, Justin Walgran', 'manual'),
]
